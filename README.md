...
```
sudo parity --config dev --unlock 0x00a329c0648769a73afac7f9381e08fb43dbea72 --password ./empty.txt --jsonrpc-hosts any --jsonrpc-apis eth,net,private,parity,personal --ws-apis eth,net,private,parity,personal --jsonrpc-cors https://remix.ethereum.org
```
